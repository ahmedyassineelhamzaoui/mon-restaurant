...
<div class="flex justify-between mx-4 mt-4">
    ...
    <a href='{{url('dashboard')}}'  class="ml-2 text-yellow-400 bg-black px-3 py-2 font-sans rounded-lg font-bold hover:bg-yellow-400 hover:text-white"><i class="fa-solid fa-plus mr-2  "></i>galerie</a>

    </div>
    <div class="flex">
        <button id="target-addMenu" class="mr-2 text-yellow-400 bg-black px-3 py-2 font-sans rounded-lg font-bold hover:bg-yellow-400 hover:text-white"><i class="fa-solid fa-plus mr-2  "></i>Add menu</button>    </div>
    </div>
    ...
    <div class="relative w-full h-full max-w-2xl md:h-auto">
        <div class="bg-white rounded-lg shadow dark:bg-gray-700 ">
            <div class="flex justify-between p-4 border-b  dark:border-gray-600">
                ...
                <button id="closeAdd-menu" type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-hide="staticModal">
                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                        <path fill-rule="evenodd" d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clip-rule="evenodd"></path>
                    </svg>
                </button>
            </div>
            <form action="{{url('DashboardMenu')}}"  method="post" enctype="multipart/form-data">
                @csrf
                <div class="mx-4 mt-6">
                    <div class="mt-1">
                    ...
                    <div class="mt-1">
                        ...
                        <input type="number" name="menu_price"  id="menu_name" class="py-2 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full px-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                    </div>
                    <div class="mt-1">
                    ...
                    <div class="mt-1">
                        ...
                        <textarea name="menu_description" id="menu_description" class="bg-gray-50 rounded w-full border border-gray-300 p-2" placeholder="Descreption of Menu" rows="5"></textarea>
                    </div>
                </div>
                <!-- Modal footer -->
            ...
            <tbody>
                ...
                <tr class="bg-white border-b dark:bg-gray-900 dark:border-gray-700">
                    ...
                    <td class="px-6 py-4 text-center">
                        <img style="width:60px;height:60px;border-radius:50%" src="/myimages/{{$menu->menu_picture}}" alt="foody">
                    </td>
                    <td class="px-6 py-4">
                    ...
                    <td class="px-6 py-4 text-center">
                            <div class="flex">                                
                                <a href="{{ url('/editMenu/'.$menu->id)}}"   class="mr-2">
                                ...
                                <form method="post"  action="{{ route('DashboardMenu.destroy', $menu->id) }}"    >                             
                               @csrf
                                @method('delete')
                                <button  type="submit">
