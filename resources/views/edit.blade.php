...
<div class="w-full mt-4 px-24">
    <div class="relative overflow-x-auto shadow-md sm:rounded-lg w-full">
        <form action="{{route('dashboard.update',$image->id)}}"   method="post" class="border border-gray-200" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="mx-4 mt-6 ">
                <div class="w-full">
                    ...
                    <input type="file"  name="myplat_picture"  id="Upicture_dishes" class="py-2 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full px-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" >
                </div>
                <div class="mt-1">
                    ...
                    <textarea  name="plat_descreption" id="Udescreption_dishes" class="bg-gray-50 rounded w-full border border-gray-300 p-2" placeholder="Descreption of dishes" rows="5">{{$image->description}}</textarea>
                </div>
